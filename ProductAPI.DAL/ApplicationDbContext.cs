...
namespace ProductAPI.DAL
{
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Category>().HasData(new Category { CategoryId = 1, CategoryName = "Лесные" });
            modelBuilder.Entity<Category>().HasData(new Category { CategoryId = 2, CategoryName = "Комнатные" });
            modelBuilder.Entity<Category>().HasData(new Category { CategoryId = 3, CategoryName = "Лекарственный" });
            modelBuilder.Entity<Category>().HasData(new Category { CategoryId = 4, CategoryName = "Садовые" });
